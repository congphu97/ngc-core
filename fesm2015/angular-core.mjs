...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AdjustFontsizeDirective, [{
            type: Directive,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AspectRatioDirective, [{
            type: Directive,
...
function destroyCmp(instance, destroyMethodName) {
    ...
    destroyed$ === null || destroyed$ === void 0 ? void 0 : destroyed$.next();
}
...
function Unsubscriber() {
    return (target) => {
        ...
        target.prototype.ngOnDestroy = function () {
            var _a;
            (_a = this[DESTROY_CMP_SUBJECT_NAME]) === null || _a === void 0 ? void 0 : _a.next();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AutoResetDirective, [{
            type: Directive,
...
BackButtonDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: BackButtonDirective, selectors: [["", "backButton", ""]], hostBindings: function BackButtonDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
DetectScrollDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: DetectScrollDirective, selectors: [["", "detectScroll", ""]], hostBindings: function DetectScrollDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DetectScrollDirective, [{
            type: Directive,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DisableControlDirective, [{
            type: Directive,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MaxLessThanDirective, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MinGreaterThanDirective, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgInitDirective, [{
            type: Directive,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgVarDirective, [{
            type: Directive,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(EmptyPipe, [{
            type: Pipe,
            args: [{ name: 'empty' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CapitalizeFirstPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CommasPipe, [{
            type: Pipe,
            args: [{ name: 'commas' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ConvertPercentPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(Filter2Pipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FixedPipe, [{
            type: Pipe,
            args: [{ name: 'fixed' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FlagIconPipe, [{
            type: Pipe,
            args: [{ name: 'flagIcon' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HourMeridiemPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ImagePipe, [{
            type: Pipe,
            args: [{ name: 'image' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(IncludesPipe, [{
            type: Pipe,
            args: [{ name: 'includes' }]
        }], null, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(IsContrastPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(IsFinitePipe, [{
            type: Pipe,
            args: [{ name: 'isFinite' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(KUnitPipe, [{
            type: Pipe,
            args: [{ name: 'kUnit' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(LinkPipe, [{
            type: Pipe,
            args: [{ name: 'link' }]
        }], null, { transform: [] });
})();
...
class MarkTextPipe {
    ...
    transform(html, markText, isSearchMode, isEscapeHtmlTags = true) {
        ...
        if ((html === null || html === void 0 ? void 0 : html.length) && (markText === null || markText === void 0 ? void 0 : markText.length)) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MarkTextPipe, [{
            type: Pipe,
            args: [{ name: 'markText' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MomentDatePipe, [{
            type: Pipe,
            args: [{ name: 'momentDate' }]
        }], function () {
        return [{ type: DateTimeConfig, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MomentFromNowPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PadNumberPipe, [{
            type: Pipe,
            args: [{ name: 'padNumber' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(Percent2Pipe, [{
            type: Pipe,
            args: [{ name: 'percent2' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TimeStringPipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TimerPipe, [{
            type: Pipe,
            args: [{ name: 'timer' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TrackByFnPipe, [{
            type: Pipe,
            args: [{ name: 'trackByFn' }]
        }], null, { transform: [] });
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(UnitPipe, [{
            type: Pipe,
            args: [{ name: 'unit' }]
        }], null, { transform: [] });
})();
...
class StorageService {
    ...
    updateCookie(key, updateData) {
        ...
        this.setCookie(key, Object.assign(Object.assign({}, data), updateData));
    }
    /**
     * @param {string} key
     * @return {void}
    ...
    updateLocal(key, updateData) {
        ...
        this.setLocal(key, Object.assign(Object.assign({}, data), updateData));
    }
    /**
     * @param {string} key
     * @return {void}
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(StorageService, [{
        ...
        return [{ type: StorageConfig, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [STORAGE_CONFIG]
                    }] }, { type: i1$3.CookieService }];
    }, null);
})();
...
class ApiService {
    ...
    setForceReloadDelayTime(forceReloadDelayTime) {
        var _a;
        (_a = this._forceReloadDebounce) === null || _a === void 0 ? void 0 : _a.cancel();
    ...
    call(url, method = 'get', params = {}, headers = {}, options) {
        return new Observable((observer) => {
            ...
            const httpHeaders = headers === null
                ...
                : this._setHeaders(Object.assign(Object.assign({}, defaultHttpHeaders), headers));
            ...
            let newOptions = Object.assign(Object.assign({}, options), { headers: httpHeaders });
            let newParams;
            if (hasQueryParams) {
            ...
            this._http[method](newURL, newParams, newOptions)
                .pipe((options === null || options === void 0 ? void 0 : options.reportProgress) ? takeWhile((res) => res.type <= 4) : take(1), finalize(() => { this._caching[url] = true; this._forceReloadDebounce(); }))
    ...
    upload(url, files, headers = {}, options) {
        return new Observable((observer) => {
            ...
            const newOptions = Object.assign(Object.assign({}, options), { headers: httpHeaders });
            ...
            this._http.post(fullURL, formData, newOptions)
                .pipe((options === null || options === void 0 ? void 0 : options.reportProgress) ? takeWhile((res) => res.type <= 4) : take(1))
                .subscribe((response) => observer.next(response), (error) => observer.error(this._failCallback(error)), () => observer.complete());
        });
    }
    /**
    ...
    _setHeaders(headers) {
        ...
        const accessToken = this._accessToken || (authorized === null || authorized === void 0 ? void 0 : authorized.accessToken);
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ApiService, [{
        ...
        return [{ type: ServerConfig, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [SERVER_CONFIG]
                        ...
                        type: Inject,
                        args: [STORAGE_CONFIG]
                    }] }, { type: i1$4.HttpClient }, { type: StorageService }];
    }, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CanDeactivateGuardService, [{
            type: Injectable
        }], null, null);
})();

moment.updateLocale('vi', Object.assign(Object.assign({}, vi), { months: _.split('Tháng 1_Tháng 2_Tháng 3_Tháng 4_Tháng 5_Tháng 6_Tháng 7_Tháng 8_Tháng 9_Tháng 10_Tháng 11_Tháng 12', '_'), weekdays: _.split('Chủ nhật_Thứ hai_Thứ ba_Thứ tư_Thứ năm_Thứ sáu_Thứ bảy', '_') }));
class LocaleService {
    /**
     * @constructor
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(LocaleService, [{
            type: Injectable
        }], function () {
        return [{ type: AppConfig, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [APP_CONFIG]
                    }] }, { type: i1$5.TranslateService }];
    }, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(LoopService, [{
            type: Injectable
        }], null, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PageService, [{
        ...
        return [{ type: AppConfig, decorators: [{
                        ...
                        type: Inject,
                        args: [APP_CONFIG]
                    }] }, { type: i1$6.Router }, { type: i1$2.Title }, { type: StorageService }];
    }, null);
})();
...
class ServiceWorkerService {
    ...
    requestSubscription(options, callback) {
        if (!this._swPush.isEnabled || 'safari' in window)
            return;
        const serverPublicKey = (options === null || options === void 0 ? void 0 : options.serverPublicKey) || this.serverConfig.fcmPublicKey;
        if (!serverPublicKey)
            return;
    ...
    enablePushNotification(options, callback) {
        ...
        this.requestSubscription(options, (subscription) => {
            const subscriptionEndpoint = (options === null || options === void 0 ? void 0 : options.subscriptionEndpoint) || this.serverConfig.fcmSubscriptionEndpoint;
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ServiceWorkerService, [{
            type: Injectable
        }], function () {
        return [{ type: AppConfig, decorators: [{
                        type: Optional
                        ...
                        type: Inject,
                        args: [SERVER_CONFIG]
                    }] }, { type: i1$7.SwPush }, { type: i1$7.SwUpdate }, { type: ApiService }];
    }, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(WebNotificationService, [{
            type: Injectable
        }], function () {
        return [{ type: AppConfig, decorators: [{
                        type: Optional
...
class WebSocketService {
    ...
    connect(config) {
        return new Observable((observer) => {
            const url = (config === null || config === void 0 ? void 0 : config.url) || this.serverConfig.wsURL;
            const namespace = config === null || config === void 0 ? void 0 : config.namespace;
            const authorized = this._storageService.getCookie(this.storageConfig.authorizedKey);
            const token = this._accessToken || (authorized === null || authorized === void 0 ? void 0 : authorized.accessToken);
            const uri = _.join([url, namespace], '/');
            const options = Object.assign({ auth: { token } }, config === null || config === void 0 ? void 0 : config.options);
    ...
    emit(event, data) {
        var _a;
        (_a = this._socket) === null || _a === void 0 ? void 0 : _a.emit(event, data);
    }
    /**
     * @param {string} event
     * @return {Observable}
    ...
    on(event) {
        return new Observable((observer) => {
            var _a;
            (_a = this._socket) === null || _a === void 0 ? void 0 : _a.on(event, (data) => observer.next(data));
        });
    }
    /**
     * @return {void}
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(CoreModule, { declarations: [
            /* Component Inject (Do not remove) */
            /* End Component Inject (Do not remove) */
            /* Directive Inject (Do not remove) */
            AdjustFontsizeDirective, AspectRatioDirective, AutoFocusDirective,
            ...
            SafeHtmlPipe, TimeStringPipe, TimerPipe,
            TrackByFnPipe, UnitPipe
        ], imports: [HttpClientModule, RouterModule, BrowserModule, TranslateModule], exports: [BrowserModule, TranslateModule,
            /* Component Inject (Do not remove) */
            /* End Component Inject (Do not remove) */
            /* Directive Inject (Do not remove) */
            AdjustFontsizeDirective, AspectRatioDirective, AutoFocusDirective,
    ...
    static copyField(value) {
        ...
        switch (typeof value) {
            ...
            case 'number':
                ...
                break;
            default:
                v = _.slice(value, 0, value === null || value === void 0 ? void 0 : value.length);
                break;
        }
        return v;
    }
